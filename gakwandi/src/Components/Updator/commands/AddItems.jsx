...
function AddItems() {
  ...
  const [newItem, setNewItem] = useState({ name: '', category: '', price: '', quantity: '', image: null });
  ...
  const addItemToList = () => {
    ...
    // Reset form fields
    setNewItem({ name: '', category: '', price: '', quantity: '', image: null });
  ...
  const handleAddToStore = async () => {
    ...
    try {
      ...
      const response = await fetch('https://gakwandi-project.glitch.me/api/adminadd', {
        method: 'POST',
        headers: {
